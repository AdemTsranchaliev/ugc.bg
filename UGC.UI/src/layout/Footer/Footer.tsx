...
const FooterLink = styled(Link)(({ theme }) => ({
  ...
  ...theme.applyStyles('light', { color: theme.vars.palette.text.primary }),
...
export const Footer = () => {
  ...
  const textColor = { color: 'text.hint', ...theme.applyStyles('light', { color: 'text.secondary' }) };
  ...
  return (
    <Box sx={{ borderTop: '1px solid', borderColor: 'divider' }}>
      ...
      <Box sx={{ py: { xs: 3, sm: 1.5 }, borderTop: '1px solid', borderColor: 'divider' }}>
        <Container>
          <Stack
